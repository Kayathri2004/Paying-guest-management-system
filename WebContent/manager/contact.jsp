...
<div class="w3-container" id="contact">
    ...
    <i class="fa fa-map-marker w3-text-blue" style="width:30px"></i> Tirunelveli<br>
    <i class="fa fa-phone w3-text-blue" style="width:30px"></i> Phone: 9342045662<br>
    <i class="fa fa-envelope w3-text-blue" style="width:30px"> </i> Email: skayathri37@gmail.com<br>
