...
<div class="w3-bar w3-white w3-large">
  <a href="" class="w3-bar-item w3-button w3-blue w3-mobile"><img src="../images/logo_white.png" style="width: 25px;height: 25px;"></a>

  <a href="myrequests.jsp" class="w3-bar-item w3-button w3-mobile">My Bookings</a>
  <a href="searchpg.html" class="w3-bar-item w3-button w3-mobile">PG</a>
  <a href="about.jsp" class="w3-bar-item w3-button w3-mobile">About us</a>
